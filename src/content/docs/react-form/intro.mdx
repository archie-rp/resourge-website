---
title: "Quick Start"
description: "A simple and basic controlled hook form. Aiming to create forms with minimal effort."
---
...
Note: Wrapping the form fields with `<form></form>` is optional. 
</Callout>
...
description: "Resource Scheme is a better improved schema validation to replace the other libraries like, yup, zod, fast-validator, etc."
---
...
We can read the errors by using [`getErrors`](/docs/react-form/actions#geterrors)

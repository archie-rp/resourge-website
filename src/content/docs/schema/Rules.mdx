...
- [test](/docs/schema/rules#test)
- [asyncTest](/docs/schema/rules#asynctest)

Additionally, there are some predefined normal rules:

- [Any](/docs/schema/any)
- [Array](/docs/schema/array)
- [Boolean](/docs/schema/boolean)
- [Date](/docs/schema/date)
- [Number](/docs/schema/number)
- [Object](/docs/schema/object)
- [String](/docs/schema/string)

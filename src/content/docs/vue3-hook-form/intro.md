...
- **`getIsDirtyField(key)`**: Checks if a specific field in the form has been modified.
...
- **`isDirty`**: Indicates whether the form has been modified.
...
- **`resetIsDirty`**: Resets the dirty state of the form.
